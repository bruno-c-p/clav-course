package module_two.bank_inheritance.application;

import module_two.bank_inheritance.entities.*;
...
public class Program {
    ...
    public static int accountTypeMenu() {

        StringBuilder sb = new StringBuilder();
        sb.append("Choose an account type:\n\n");
        sb.append("1 - Checking account\n");
        sb.append("2 - Special account\n");
        sb.append("3 - University account\n");
    ...
    private static void verifyBalanceOfClient(List<Client> clients, List<Account> accounts) {
        ...
        for (Account account : accounts) {
            ...
            if (account.getClient() == accounts.get(client - 1).getClient()) {
                ...
                JOptionPane.showMessageDialog(null, "Balance: R$" + df.format(account.getBalance()));
            }
        }
    }
    ...
    private static String agenciesList(List<Agency> agencies) {
        ...
        for (Agency agency : agencies) {
            ...
            list.append(agencies.indexOf(agency) + 1).append(agency.toString()).append("\n");
        }
    ...
    private static String clientsList(List<Client> clients) {
        ...
        for (Client client : clients) {
            ...
            list.append(clients.indexOf(client) + 1).append(client.toString()).append("\n");
        }
    ...
    private static String accountsList(List<Account> accounts) {
        ...
        for (Account account : accounts) {
            ...
            list.append(accounts.indexOf(account) + 1).append(account.toString()).append("\n");
        }
